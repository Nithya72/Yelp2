...
import { addMenuDetails } from '../../actions/menuActions/addMenuActions';
...
class AddMenu extends Component {
    ...
    updateDishHandler(e) {
        ...
        axios.post(configurePath.api_host+'/updateMenu', dish)
            .then((response) => {
    ...
    addDishHandler(e) {
        ...
        console.log("add menu restaurant ID: ", this.state.restaurant);
    ...
    submitProfilePic = (e) => {
        ...
        axios.post(configurePath.api_host+"/uploadProfilePic", picData)
            .then((response) => {
                if (response.status === 200) {
                    this.setState({
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        addFlag: state.resState.addFlag
    };
};
